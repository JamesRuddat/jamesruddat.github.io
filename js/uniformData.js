...
export const cadetGrades = [
    ...
    { group: "Cadet Grades", value: "cadet_second_lieutenant", label: "Cadet Second Lieutenant (C/2d Lt)", level: null, img: `/uniformImages/grade/cadetGrades/` },
    { group: "Cadet Grades", value: "cadet_first_lieutenant", label: "Cadet First Lieutenant (C/1st Lt)", level: null, img: `/uniformImages/grade/cadetGrades/` },
    { group: "Cadet Grades", value: "cadet_captain", label: "Cadet Captain (C/Capt)", level: null, img: `/uniformImages/grade/cadetGrades/` },
