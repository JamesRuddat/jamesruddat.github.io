...
export const cadetGrades = [
    ...
    { group: "Cadet Grades", value: "cadet_airman", label: "Cadet Airman (C/Amn)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_airman_first_class", label: "Cadet Airman First Class (C/A1C)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_senior_airman", label: "Cadet Senior Airman (C/SrA)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_staff_sergeant", label: "Cadet Staff Sergeant (C/SSgt)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_technical_sergeant", label: "Cadet Technical Sergeant (C/TSgt)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_master_sergeant", label: "Cadet Master Sergeant (C/MSgt)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_senior_master_sergeant", label: "Cadet Senior Master Sergeant (C/SMSgt)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_chief_master_sergeant", label: "Cadet Chief Master Sergeant (C/CMSgt)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_second_lieutenant", label: "Cadet Second Lieutenant (C/2d Lt)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_first_lieutenant", label: "Cadet First Lieutenant (C/1st Lt)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_captain", label: "Cadet Captain (C/Capt)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_major", label: "Cadet Major (C/Maj)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_lieutenant_colonel", label: "Cadet Lieutenant Colonel (C/Lt Col)", level: null, img: null },
    { group: "Cadet Grades", value: "cadet_colonel", label: "Cadet Colonel (C/Col)", level: null, img: null },
];
...
export const seniorGrades = [
    ...
    { group: "Senior Grades", value: "staff_sergeant", label: "Staff Sergeant (SSgt)", level: null, img: null },
    { group: "Senior Grades", value: "technical_sergeant", label: "Technical Sergeant (TSgt)", level: null, img: null },
    { group: "Senior Grades", value: "master_sergeant", label: "Master Sergeant (MSgt)", level: null, img: null },
    { group: "Senior Grades", value: "senior_master_sergeant", label: "Senior Master Sergeant (SMSgt)", level: null, img: null },
    { group: "Senior Grades", value: "chief_master_sergeant", label: "Chief Master Sergeant (CMSgt)", level: null, img: null },
    ...
    { group: "Senior Grades", value: "second_lieutenant", label: "Second Lieutenant (2d Lt)", level: null, img: null },
    { group: "Senior Grades", value: "first_lieutenant", label: "First Lieutenant (1st Lt)", level: null, img: null },
    { group: "Senior Grades", value: "captain", label: "Captain (Capt)", level: null, img: null },
    { group: "Senior Grades", value: "major", label: "Major (Maj)", level: null, img: null },
    { group: "Senior Grades", value: "lieutenant_colonel", label: "Lieutenant Colonel (Lt Col)", level: null, img: null },
    { group: "Senior Grades", value: "colonel", label: "Colonel (Col)", level: null, img: null },
    { group: "Senior Grades", value: "brigadier_general", label: "Brigadier General (Brig Gen)", level: null, img: null },
    { group: "Senior Grades", value: "major_general", label: "Major General (Maj Gen)", level: null, img: null },
];
